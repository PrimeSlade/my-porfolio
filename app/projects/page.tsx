      ...
      <div className="border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6 py-10 flex flex-col gap-2">
          ...
          <p className="font-mono text-sm text-neutral-500">
            ...
            <span className="text-white">{projects.length} builds</span>
          </p>
        </div>
      </div>
        ...
        <div className="w-[22%] sticky top-20 self-start hidden lg:block">
          <div className="border border-white/10 bg-[#050505]">
            <div className="flex items-center gap-2 px-4 py-3 border-b border-white/10">
              ...
              <h3 className="text-[11px] tracking-[0.18em] uppercase font-mono font-bold text-white">
                Timeline
              </h3>
            </div>
            ...
            <div className="px-4 py-3 border-t border-white/10 text-[10px] font-mono tracking-[0.15em] uppercase text-neutral-600">
